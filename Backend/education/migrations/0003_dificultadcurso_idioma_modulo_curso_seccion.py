    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profesor_curso', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.docente')),
                ('dificultad_curso', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='education.dificultadcurso')),
                ('idioma_curso', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='education.idioma')),
                ('modulo_curso', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='education.modulo')),
            ],
        ),
        migrations.CreateModel(
            name='Seccion',
            fields=[
                ...
                ('seccion_del_curso', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='education.curso')),
            ],
        ),
    ]
